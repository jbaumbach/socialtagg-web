...
function reducer(item, memo, sep, prependSeperator) {
  var foo = ''
  , c = new RegExp(sep, 'g')
  , q = new RegExp('"', 'g')
  , n = new RegExp('\n', 'g');
...
exports.stringify = function (input, sep) {
  ...
  if (Array.isArray(input) && !Array.isArray(input[0])) {
    ...
    */
    ...
    // 2013-05-06 JB: bug fix - first column wasn't outputting a 
    // comma.  Added last parameter to tell function to add a comma.
